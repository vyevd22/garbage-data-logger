    ...
    try:
        ...
        message = client.messages.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"Write a short 'honourable mention' report for a football player in a Discord match report. Player: {username} [{position}]. What they did: {description}. Keep it to one or two sentences, no longer. Do not use quotation marks. Do not add any explanation or preamble, just the mention itself."
                }
            ]
        )
